...
import { useGetSupplierCustomers, useRemoveCustomer} from "@/pages/customers/customer-queries.ts"; // Adjusted import
...
const SupplierCustomers = () => {
    ...
    const {
        data: customers,
        isLoading
    } = useGetSupplierCustomers(supplierId!, pageNumber, pageSize, keyword,{ enabled: !!supplierId}); // Removed activeShop logic
                    ...
                    {isLoading ? (
                        ...
                        <Can permission={permissions.GET_CUSTOMERS} messageScreen={true}>
                            <HiTable
                                ...
                                onRowClick={(row) =>  navigate(`details/${row.id}`,{ state: {
                                        goBackTo:`/suppliers/more-details/${supplierId}/customers`,
                                    }})}
