                    ...
                    {isLoading ? (
                        ...
                        <>
                            <Can permission={permissions.SUPPLIER_DETAILS}>
                                ...
                                <div
                                    className="relative h-48 bg-gradient-to-r from-green-500 to-teal-600 dark:from-green-600 dark:to-teal-700 overflow-hidden">
                                        ...
                                        <div className="flex items-end justify-between">
                                            <div>
                                                ...
                                                <div className="flex items-center mt-1 text-white/80">
                                                    ...
                                                    <span
                                                        className="text-sm">{supplier?.data?.idNumber || 'No ID'}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex-1 px-6 py-6 overflow-y-auto">
                                    ...
                                    <div
                                        className="bg-green-50 dark:bg-green-900/20 rounded-xl p-5 border border-green-100 dark:border-green-900/30 mb-6">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center">
                                                <div
                                                    className="h-9 w-9 rounded-lg bg-green-100 dark:bg-green-800/40 flex items-center justify-center mr-3.5">
                                                    <LucidePhone
                                                        className="h-4.5 w-4.5 text-green-600 dark:text-green-300"/>
                                                </div>
                                                <div>
                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Phone
                                                        Number</p>
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <p className="text-xs text-gray-500 dark:text-gray-400">Email
                                                        Address</p>
                                                    <p className="text-sm font-medium text-gray-900 dark:text-white mt-0.5">
                                    ...
                                    <div
                                        className="bg-gray-50 dark:bg-neutral-900 rounded-xl p-5 border border-gray-200 dark:border-neutral-700 mb-6">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {supplier?.data?.gpsCoordinates && (
                                                <div>
                                                    ...
                                                    {/* Google map */}
                                                    <div
                                                        className="mt-4 bg-white h-60 w-full dark:bg-neutral-800 rounded-lg border border-gray-200 dark:border-neutral-700 overflow-hidden">
                                                        {isLoaded ? (
                                                            <GoogleMap
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-6">
                                        <div
                                            className="bg-gray-50 dark:bg-neutral-900 rounded-xl p-4 border border-gray-200 dark:border-neutral-700">
