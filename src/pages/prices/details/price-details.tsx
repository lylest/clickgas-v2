                        ...
                        <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10">
                            <div className="px-6 py-4 flex justify-between items-center">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <h2 className="text-lg font-medium text-neutral-900 dark:text-white">Price Details</h2>
                                </div>
                                <button
                                    onClick={closeModal}
                                    className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                        ...
                        <div className="flex-1 overflow-y-auto p-6">
                            {isLoading ? (
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {price.notes && (
                                                <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-100 dark:border-amber-800/30">
                                                    <div className="flex">
                                                        <LucideAlertCircle className="h-5 w-5 text-amber-500 mr-3 flex-shrink-0 mt-0.5" />
                                                        <div>
                                    ...
                                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                                        <h3 className="text-lg font-medium mb-4 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 tebg-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        >
                                            <div className="flex items-center">
                                                <div className="bg-blue-50 dark:bg-blue-900/30 rounded-full h-10 w-10 flex items-center justify-center">
                          <span className="tebg-blue-600 dark:tebg-blue-300 font-medium">
                            {price?.Supplier?.firstName?.charAt(0) || ''}{price?.Supplier?.lastName?.charAt(0) || ''}
                                ...
                                <div className="flex flex-col items-center justify-center h-full text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-gray-900 dark:text-white">Price Not Found</h3>
                                    <p className="text-gray-500 dark:text-gray-400 mt-2">The price details you're looking for could not be found.</p>
                                </div>
                            )}
                        </div>
